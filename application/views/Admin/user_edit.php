              ...
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="level">
                        ...
                        <option value="Humas" <?php echo set_select('level', 'Humas', ('Humas' == $user[0]['level'])); ?>>Humas</option>
                        <option value="Umum" <?php echo set_select('level', 'Umum', ('Umum' == $user[0]['level'])); ?>>Umum</option>
                    </select>
                </div>
              </div>
              <!-- /.box-body -->
