...
CREATE TABLE `datapendaftar` (
  ...
  `berkas_magang` varchar(100) NOT NULL,
  `berkas_rekomendasi` varchar(100) NOT NULL,
  `cv` varchar(100) NOT NULL,
  `pasphoto` varchar(100) NOT NULL,
  `tanggal_magang` date NOT NULL,
  `lama_magang` varchar(5) NOT NULL,
...
INSERT INTO `kota` (`kota_id`, `kota_kode`, `kota_nama`) VALUES
...
INSERT INTO `user` (`id`, `email`, `password`, `level`, `tanggal`) VALUES
...
--
ALTER TABLE `kota`
  MODIFY `kota_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9472;
